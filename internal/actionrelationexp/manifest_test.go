...
func TestFrozenManifest(t *testing.T) {
	...
	if manifest["experiment_version"] != ExperimentVersion || manifest["seed_authority"] != SeedAuthority || manifest["training_observations_per_curriculum"] != float64(16) || manifest["maximum_normalized_guards"] != float64(512) || PlanCommit != "a3e18b10a01cf83315bff398586e91cd33544861" {
