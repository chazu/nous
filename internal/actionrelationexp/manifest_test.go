...
func TestFrozenManifest(t *testing.T) {
	...
	if manifest["experiment_version"] != ExperimentVersion || manifest["seed_authority"] != SeedAuthority || manifest["training_observations_per_curriculum"] != float64(16) || manifest["maximum_normalized_guards"] != float64(512) || PlanCommit != "95860673664799ea1e18c7cb1f7e433238830216" {
