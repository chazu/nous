			...
			each
				...
				each
					...
					if
						...
						"KubeRepairPlanSimplifiesToAtomicEdit" "longProgram" @ "primitive" @ 2 list-of "Two-step bound Kubernetes repair plan is observationally equivalent to one atomic edit on the bounded probe set" "H-CompareProgramSimplifications" make-protoconjec "conjectureName" !
