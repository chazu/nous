...
Every semantic preimage resides in the curriculum's authenticated object table
as `objects/<sha256>.json`, a regular canonical JSON leaf whose bytes hash to
its filename. An operation object is exactly
